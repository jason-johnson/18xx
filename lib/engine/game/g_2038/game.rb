        ...
        PHASES = [
          {
            ...
            tiles: [:yellow],
            operating_rounds: 2,
            status: ['group_a_corps_available'],
          },
          {
            name: '2',
            on: '4dc3',
            ...
            operating_rounds: 2,
            status: %w[can_buy_companies can_launch_growth_corps can_buy_ics_bases_stations can_buy_ships],
          },
          {
            name: '3',
            on: '5dc4',
            train_limit: { minor: 1, major: 3, al: 4 },
            tiles: %i[yellow green],
            operating_rounds: 2,
            status: %w[can_buy_companies can_launch_growth_corps can_buy_ics_bases_stations can_buy_ships al_may_form],
          },
          {
            name: '4',
            on: '6d5c',
            ...
            operating_rounds: 2,
            status: %w[can_buy_companies can_launch_growth_corps can_buy_ics_bases_stations can_buy_ships al_must_form],
          },
          {
            name: '5',
            on: '7d6c',
            ...
            tiles: %i[yellow green brown],
            operating_rounds: 2,
            status: %w[ic_must_join_al can_buy_ics_bases_stations can_buy_ships],
          },
          {
            name: '6',
            on: '9d7c',
            train_limit: { major: 2, al: 3 },
            tiles: %i[yellow green brown],
            operating_rounds: 2,
            status: %w[can_buy_ics_bases_stations can_buy_ships],
          },
        ].freeze
